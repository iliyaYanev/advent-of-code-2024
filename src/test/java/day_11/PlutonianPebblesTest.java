...
public class PlutonianPebblesTest {
    ...
    static {
        try {
            FILE_CONTENTS = GetInputFileContents.getFileAsString("src/test/resources/day_11/dayElevenInput.txt");
        } catch (IOException e) {
    ...
    public void plutonianPebblesPartOneTest() {
        long result = PlutonianPebbles.blinkStones(FILE_CONTENTS, 25);
    ...
    public void plutonianPebblesPartTwoTest() {
        long result = PlutonianPebbles.blinkStones(FILE_CONTENTS, 75);
